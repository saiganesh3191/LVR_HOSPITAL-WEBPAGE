    ...
    <section className="hero">
      <div className="hero-shell">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-signoff"><Heart size={21} strokeWidth={1.5} /><span>Helping hands.<br /><strong>Caring hearts.</strong></span><span className="hero-signoff-rule" /><p>A hospital for<br /><span data-te="మన ప్రాంత ప్రజల కోసం.">our community.</span></p></div>
        </div>
        <div className="hero-visual"><div className="hero-portrait-stack"><Link href="/doctors/prathyusha" className="hero-mini-portrait"><Image src="/images/team/prathyusha.webp" alt="Dr. Prathyusha Papishetty" fill sizes="(max-width: 760px) 30vw, 15vw" /><span><strong>Dr. Prathyusha Papishetty</strong><small>Dermatology</small><ArrowUpRight size={15} /></span></Link><Link href="/doctors/chaithanya" className="hero-mini-portrait"><Image src="/images/team/k-chaithanya.webp" alt="Dr. K. Chaithanya" fill sizes="(max-width: 760px) 30vw, 15vw" /><span><strong>Dr. K. Chaithanya</strong><small>Pediatrics</small><ArrowUpRight size={15} /></span></Link></div><span className="hero-visual-label" aria-hidden="true">YOUR PEOPLE. YOUR CARE.</span><Link href="/doctors/lakshman-sai" className="hero-photo" aria-label="View Dr. Lakshmansai Vanama's profile"><Image src="/images/team/lakshmansai-vanama.webp" alt="Dr. Lakshmansai Vanama at LVR Hospital" fill priority sizes="(max-width: 760px) 100vw, 50vw" /><div className="photo-shade" /><div className="hero-photo-copy"><span>GENERAL MEDICINE AT LVR</span><p>Dr. Lakshmansai<br /><em>Vanama</em></p></div></Link><div className="hero-care-strip"><div><strong>24/7</strong><span>Hospital care</span></div><span className="strip-line" /><div><strong>5</strong><span>Departments to explore</span></div><a href={hospital.phoneHref} aria-label="Call LVR Hospital"><Phone size={24} /></a></div></div>
      </div>
    </section>
