export const hospital = {
  ...
  mapsUrl: "https://share.google/nkkOCsoriPZYjuOPx",
  established: "2024",
...
export const doctors = [
  { sourceId: 2, slug: "lakshman-sai", name: "Dr. Lakshmansai Vanama", initials: "LV", qualification: "MBBS, MD (General Medicine)", department: "General Medicine", departmentSlug: "general-medicine", color: "sage", appointmentType: "Regular", timing: "Call to confirm the doctor’s availability", bio: "Dr. Lakshmansai Vanama is the Founder and Director of LVR Multi Speciality Hospital. His work combines general medicine with a background in critical care, including care for diabetes, high blood pressure, infections, anaemia, and low platelet counts." },
  { sourceId: 4, slug: "prathyusha", name: "Dr. Prathyusha Papishetty", initials: "PP", qualification: "MBBS, MD (Dermatology, Venereology & Leprosy)", department: "Dermatology", departmentSlug: "dermatology", color: "peach", appointmentType: "Regular", timing: "Monday-Saturday: 10:00 AM-2:30 PM and 6:00-8:30 PM", bio: "Dr. Prathyusha Papishetty is a dermatologist and MD gold medallist from JSS Medical College, Mysuru. She provides consultations for skin conditions including fungal infections, scabies, psoriasis, urticaria, and vitiligo." },
  { sourceId: 3, slug: "chaithanya", name: "Dr. K. Chaithanya", initials: "KC", qualification: "MBBS, MD (Pediatrics)", department: "Pediatrics", departmentSlug: "pediatrics", color: "lavender", appointmentType: "Regular", timing: "Call to confirm the doctor’s availability", bio: "Dr. K. Chaithanya provides pediatric consultations at LVR Multi Speciality Hospital for children’s health concerns." },
