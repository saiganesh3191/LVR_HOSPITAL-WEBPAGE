...
export function Footer() {
  return <>
    <footer className="site-footer"><div className="container">
      ...
      <div><h2>Explore LVR</h2><Link href="/about">About our hospital</Link><Link href="/doctors">Meet our doctors</Link><Link href="/departments">Our specialties</Link><Link href="/patient-guide">Patient guide</Link><Link href="/facilities">Hospital facilities</Link><Link href="/updates">Hospital updates</Link><Link href="/te" lang="te">తెలుగు సమాచారం</Link><Link href="/careers">Careers at LVR</Link></div>
