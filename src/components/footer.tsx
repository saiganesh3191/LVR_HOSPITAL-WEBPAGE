...
export function Footer() {
  return <>
    ...
    <div className="quick-contact-dock" aria-label="Quick contact"><a className="quick-contact-call" href={hospital.phoneHref}><Phone size={20} /><span><small>OPEN 24/7</small>Call hospital</span></a><a className="quick-contact-whatsapp" href={whatsappUrl()} target="_blank" rel="noopener noreferrer"><MessageCircle size={20} /><span><small>MESSAGE US</small>WhatsApp</span></a></div>
    <div className="mobile-actions" aria-label="Quick contact"><a href={hospital.phoneHref}><Phone size={19} />Call 24/7</a><a href={whatsappUrl()} target="_blank" rel="noopener noreferrer"><MessageCircle size={19} />WhatsApp</a><Link href="/appointment">Book appointment <ArrowUpRight size={17} /></Link></div>
  </>;
}
